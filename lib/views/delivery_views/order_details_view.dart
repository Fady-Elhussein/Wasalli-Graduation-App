      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ContainerWidget(
              text:
                  '  هاتف موظف التوصيل :  :    ${inProgressOrderCubitObject.inProgressOrderModel!.data![0].delivery!.phoneNumber!}',
            ),
            const SizedBox(
              height: 5,
            ),
            ...
            // ContainerWidget(
            //   text:
            //       'رقم اضافي للمرسل :    ${inProgressOrderCubitObject.inProgressOrderModel!!.data![index].alternateSenderPhoneNumber!}',
            // ),
            // const SizedBox(
            //   height: 5,
            // ),
            // ContainerWidget(
            //   text:
            //       'تعليق :    ${availableOrderModel!.data![index].comment!}',
            // ),
            // const SizedBox(
            //   height: 5,
            // ),
